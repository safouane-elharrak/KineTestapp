...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.employe.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_fname') ? 'is-invalid' : '' }}" type="text" name="employe_fname" id="employe_fname" value="{{ old('employe_fname', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_lname') ? 'is-invalid' : '' }}" type="text" name="employe_lname" id="employe_lname" value="{{ old('employe_lname', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_cin') ? 'is-invalid' : '' }}" type="text" name="employe_cin" id="employe_cin" value="{{ old('employe_cin', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_cnss') ? 'is-invalid' : '' }}" type="text" name="employe_cnss" id="employe_cnss" value="{{ old('employe_cnss', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_birthday') ? 'is-invalid' : '' }}" type="text" name="employe_birthday" id="employe_birthday" value="{{ old('employe_birthday', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_orgin') ? 'is-invalid' : '' }}" type="text" name="employe_orgin" id="employe_orgin" value="{{ old('employe_orgin', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employe_salary') ? 'is-invalid' : '' }}" type="number" name="employe_salary" id="employe_salary" value="{{ old('employe_salary', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('employe_contract') ? 'is-invalid' : '' }}" name="employe_contract" id="employe_contract">
                    ...
                    @foreach(App\Models\Employe::EMPLOYE_CONTRACT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('employe_contract', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('employe_start') ? 'is-invalid' : '' }}" type="text" name="employe_start" id="employe_start" value="{{ old('employe_start') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('employe_end') ? 'is-invalid' : '' }}" type="text" name="employe_end" id="employe_end" value="{{ old('employe_end') }}">
