    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.update", [$patient->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('patient_gender') ? 'is-invalid' : '' }}" name="patient_gender" id="patient_gender" required>
                    ...
                    @foreach(App\Models\Patient::PATIENT_GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('patient_gender', $patient->patient_gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_fname') ? 'is-invalid' : '' }}" type="text" name="patient_fname" id="patient_fname" value="{{ old('patient_fname', $patient->patient_fname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_lname') ? 'is-invalid' : '' }}" type="text" name="patient_lname" id="patient_lname" value="{{ old('patient_lname', $patient->patient_lname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_cin') ? 'is-invalid' : '' }}" type="text" name="patient_cin" id="patient_cin" value="{{ old('patient_cin', $patient->patient_cin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('patient_birthday') ? 'is-invalid' : '' }}" type="text" name="patient_birthday" id="patient_birthday" value="{{ old('patient_birthday', $patient->patient_birthday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_mobile') ? 'is-invalid' : '' }}" type="text" name="patient_mobile" id="patient_mobile" value="{{ old('patient_mobile', $patient->patient_mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_email') ? 'is-invalid' : '' }}" type="text" name="patient_email" id="patient_email" value="{{ old('patient_email', $patient->patient_email) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('patient_type') ? 'is-invalid' : '' }}" name="patient_type" id="patient_type">
                    ...
                    @foreach(App\Models\Patient::PATIENT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('patient_type', $patient->patient_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('patient_insurance') ? 'is-invalid' : '' }}" name="patient_insurance" id="patient_insurance">
                    ...
                    @foreach(App\Models\Patient::PATIENT_INSURANCE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('patient_insurance', $patient->patient_insurance) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('patient_profession') ? 'is-invalid' : '' }}" type="text" name="patient_profession" id="patient_profession" value="{{ old('patient_profession', $patient->patient_profession) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('patient_note') ? 'is-invalid' : '' }}" name="patient_note" id="patient_note">{!! old('patient_note', $patient->patient_note) !!}</textarea>
