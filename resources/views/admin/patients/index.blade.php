                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\Patient::PATIENT_GENDER_SELECT as $key => $item)
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Patient::PATIENT_INSURANCE_SELECT as $key => $item)
                                <option value="{{ $key }}">{{ $item }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'patient_cin', name: 'patient_cin' },
{ data: 'patient_mobile', name: 'patient_mobile' },
{ data: 'patient_insurance', name: 'patient_insurance' },
